  ...
  methods: {
    ...
    checked (input, event) {
      ...
      if (
        ...
        // check
        sessionStorage.setItem('listItemPreviewSelected_cardOperations', sessionStorage.getItem('listItemPreviewSelected_cardOperations') + 'کارت' + ' -> ' + input.title.trim() + '*')
      } else {
        // uncheck
        const textAfterRemoveItem = sessionStorage.getItem('listItemPreviewSelected_cardOperations').replace('کارت' + ' -> ' + input.title.trim() + '*', '')
        sessionStorage.setItem('listItemPreviewSelected_cardOperations', textAfterRemoveItem)
      }
