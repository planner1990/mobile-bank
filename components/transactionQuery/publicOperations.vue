...
export default {
  name: 'PublicOperationsComponent',
  props: {
    cards: Object([]),
    listType: {
      type: String,
  ...
  methods: {
    ...
    AllCheckBox: function () {
      ...
      this.items.forEach((i) => {
        checked.push(i.url)
        sessionStorage.setItem('listItemPreviewSelected_publicOperations', sessionStorage.getItem('listItemPreviewSelected_publicOperations') + 'عمومی' + ' -> ' + i.title + '*')
      })
