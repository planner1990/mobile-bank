  ...
  methods: {
    ...
    AllCheckBox: function () {
      ...
      this.items.forEach((i) => {
        checked.push(i.url)
        sessionStorage.setItem('listItemPreviewSelected_cardReissueOperations', sessionStorage.getItem('listItemPreviewSelected_cardReissueOperations') + 'صدور کارت' + ' -> ' + i.title + '*')
      })
