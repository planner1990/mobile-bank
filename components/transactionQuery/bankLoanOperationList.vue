  ...
  methods: {
    ...
    checked (input, event) {
      ...
      if (
        ...
        // check
        sessionStorage.setItem('listItemPreviewSelected_bankLoanOperationList', sessionStorage.getItem('listItemPreviewSelected_bankLoanOperationList') + 'بانک loan' + ' -> ' + input.title.trim() + '*')
      } else {
        // uncheck
        const textAfterRemoveItem = sessionStorage.getItem('listItemPreviewSelected_bankLoanOperationList').replace('بانک loan' + ' -> ' + input.title.trim() + '*', '')
        sessionStorage.setItem('listItemPreviewSelected_bankLoanOperationList', textAfterRemoveItem)
      }
