  ...
  methods: {
    ...
    checked (input, event) {
      ...
      if (
        ...
        // check
        sessionStorage.setItem('listItemPreviewSelected_userOperations', sessionStorage.getItem('listItemPreviewSelected_userOperations') + 'کاربری' + ' -> ' + input.title.trim() + '*')
      } else {
        // uncheck
        const textAfterRemoveItem = sessionStorage.getItem('listItemPreviewSelected_userOperations').replace('کاربری' + ' -> ' + input.title.trim() + '*', '')
        sessionStorage.setItem('listItemPreviewSelected_userOperations', textAfterRemoveItem)
      }
    ...
    AllCheckBox: function () {
      ...
      this.items.forEach((i) => {
        checked.push(i.url)
        sessionStorage.setItem('listItemPreviewSelected_userOperations', sessionStorage.getItem('listItemPreviewSelected_userOperations') + 'کاربری' + ' -> ' + i.title + '*')
      })
