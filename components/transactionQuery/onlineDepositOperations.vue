...
export default {
  name: 'OnlineDepositOperationsComponent',
  props: {
    cards: Object([]),
    listType: {
      type: String,
  ...
  methods: {
    ...
    operation () {
      ...
      reportManager.operationList(this.operationType, this.$axios).then((response) => {
        ...
        const operationOnlineDepositList = operationList.onlineDepositOperation
    ...
    AllCheckBox: function () {
      ...
      this.items.forEach((i) => {
        checked.push(i.url)
        sessionStorage.setItem('listItemPreviewSelected_onlineDepositOperations', sessionStorage.getItem('listItemPreviewSelected_onlineDepositOperations') + 'افتتاح حساب' + ' -> ' + i.title + '*')
      })
