<template>
  <v-card>
    ...
    <v-container fluid>
      ...
      />
      <v-text-field
        v-model="filter.reportFilter.nationalCode"
        dense
        outlined
      ...
      />
      <v-text-field
        v-model="filter.reportFilter.customerNo"
        dense
        outlined
        :label="$t('filters.customerNo')"
        prepend-icon="mdi-credit-card"
      />
      <v-text-field
        v-model="filter.reportFilter.depositNo"
        dense
        outlined
        :label="$t('filters.depositNo')"
        prepend-icon="mdi-credit-card"
      />
    </v-container>
  </v-card>
...
export default {
  ...
  data () {
    return {
      ...
      onlineDepositStatus: onlineDepositManager.onlineDepositStatusSmsEnabled
    }
  },
  computed: {
    ...mapGetters({
