<template>
  <v-app dark>
    <v-container>
      ...
      >
        <v-card>
          <v-card-text style="font-size: 20px;font-weight: bold;margin-top: 100px;">
            <center>
              {{ $t('error.' + error.statusCode) }} - با کد خطای ( {{ error.statusCode }} )
            </center>
          </v-card-text>
          ...
          <div class="main-error-page">
            ...
            <h1 class="error-title" style="direction: ltr">
              Woops! <br>Something went wrong :(
            </h1>
            <h2 class="error-subtitle" style="direction: ltr">
...
export default {
  ...
  mounted: function () {
    try {
      ...
      this.src = require('@/static/404.jpeg')
    }
  }
}
</script>
